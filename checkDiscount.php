...
<div class="container p-5 w-50">
        ...
        <div class="form-group">
            ...
            <input type="text" id="dCode" class="form-control"  placeholder="You have any discount code?">
        </div>
        <p id="discount"></p>
       ...
       var xmlhttp = new XMLHttpRequest();
        xmlhttp.onreadystatechange = function() {
            if (this.readyState == 4 && this.status == 200) {
                ...
                var result = this.responseText.localeCompare("Sorry, your code is invalid");
                if (result!=0) {
                  hasDiscount=1;
                }
            }
